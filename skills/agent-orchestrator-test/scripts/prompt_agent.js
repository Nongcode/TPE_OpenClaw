...
function buildPromptSystemPrompt(agentId, openClawHome) {
  ...
  return [
    ...
    "- Neu tao video, uu tien clip ngan khoang 8 giay va co loi doc tieng Viet ngan gon gioi thieu 2-4 thong so/chuc nang chinh.",
...
function buildPromptDraftPrompt(params) {
  ...
  const lines = [
    ...
    "- Neu co VIDEO prompt, them ro: tong thoi luong khoang 8 giay, co loi doc tieng Viet ngan gon doc thong so/chuc nang chinh, khong chen text len khung hinh.",
    "",
    "MARKER BAT BUOC:",
...
function buildPromptRevisePrompt(params) {
  ...
  const lines = [
    ...
    "- Neu sua VIDEO prompt, van uu tien tong thoi luong khoang 8 giay va loi doc tieng Viet ngan gon neu yeu cau workflow dang can.",
    "",
    "MARKER BAT BUOC:",
    "PROMPT_DECISION: <image|video|both>",
    "IMAGE_PROMPT_BEGIN",
