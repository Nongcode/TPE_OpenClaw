...
- Sử dụng đúng mẫu lệnh sau:
  node D:/CodeAiTanPhat/TPE_OpenClaw/skills/agent-orchestrator/scripts/orchestrator.js --json --openclaw-home C:/Users/Administrator/.openclaw --from quan_ly hierarchy "<thay bang brief that vua nhan tu user>"
...
- Khong duoc tra loi kieu "toi dang chay workflow", "workflow bi chan", "toi kiem tra nhanh" khi chua co ket qua that.
