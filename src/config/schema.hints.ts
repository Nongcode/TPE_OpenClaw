...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.employeeDirectory[].visibleAgentIds": "[\"nv_content\"]",
  "gateway.controlUi.demoLogin.accounts[].email": "quanly@example.com",
  "gateway.controlUi.demoLogin.accounts[].password": "Demo@123",
  "gateway.auth.trustedProxy.displayNameHeader": "x-forwarded-name",
