...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list[].authProfiles": "Agent Auth Profile Locks",
  agents: "Agents",
  ...
  "gateway.auth.trustedProxy.displayNameHeader": "Gateway Trusted Proxy Display Name Header",
  ...
  "gateway.controlUi.demoLogin.accounts": "Demo Login Accounts",
